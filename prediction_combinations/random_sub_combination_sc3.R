...
leader_board <- read_csv(file.path(submission_folder, "leaderboard_all_rounds_sc3.csv"))
...
saveRDS(repeated_scores, paste0("prediction_combinations/SC3/SC3_", n_samples, "random_subs_scores.rds"))
