...
leaderboard <- read_csv(file.path(submission_folder, "leaderboard_final_sc3.csv"))
...
validation_data<- read_csv("~/Seafile/validation_data/sc3gold.csv") %>% select(required_columns)
...
#saveRDS(overall_scores, "./prediction_combinations/SC3/combi_methods_N10_scores.rds")
overall_scores <- readRDS("./prediction_combinations/SC3/combi_methods_N10_scores.rds")
