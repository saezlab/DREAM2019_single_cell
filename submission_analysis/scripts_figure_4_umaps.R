...
ggsave("./publication/figures/figure4/sc3_UMAP_independent_data_legend.pdf", height = 4, width = 5)
ggsave("./publication/figures/figure4/sc3_UMAP_independent_data_legend.jpeg", height = 4, width = 5)

# give a try to tSNE:
# library(Rtsne)
# tsne_res_data <- Rtsne::Rtsne(measured_data[,-1:-4],
#                      perplexity = 50,
#                      pca = TRUE,
#                      max_iter = 1000,
#                      verbose = TRUE,
...
# 
# 
# measured_data %>% bind_cols(tibble(tsne.x = tsne_res_data$Y[,1],
#                                    tsne.y = tsne_res_data$Y[,2])) %>% 
#     #sample_frac(0.1) %>% 
#     ggplot() + 
#     geom_point(aes(tsne.x,tsne.y,col=cell_line),size = 0.2) +
#     # coord_fixed() +
#     theme_bw() + 
#     ggtitle("data") +
#     labs(x="",y="") +
...
ggsave("./publication/figures/figure4/sc3_UMAP_independent_data.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure4/sc3_UMAP_independent_data.jpeg", height = 4, width = 4)
...
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team1.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team1.jpeg", height = 4, width = 4)

ggplots$ggs[[2]]+ ggtitle("team 2")
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team2.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team2.jpeg", height = 4, width = 4)

ggplots$ggs[[3]]+ ggtitle("team 3")
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team3.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team3.jpeg", height = 4, width = 4)

ggplots$ggs[[4]]+ ggtitle("team 4")
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team4.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure4/sc3_UMAP_independent_team4.jpeg", height = 4, width = 4)
...
ggsave("./publication/figures/figure3/sc3_UMAP_data_teams1_4_data.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure3/sc3_UMAP_data_teams1_4_data.jpeg", height = 4, width = 4)

preped_data%>% filter(submitterId == "icx_bxai") %>% create_plot()
ggsave("./publication/figures/figure3/sc3_UMAP_data_teams1_4_team1.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure3/sc3_UMAP_data_teams1_4_team1.jpeg", height = 4, width = 4)

preped_data%>% filter(submitterId == "PaL") %>% create_plot()
ggsave("./publication/figures/figure3/sc3_UMAP_data_teams1_4_team4.pdf", height = 4, width = 4)
ggsave("./publication/figures/figure3/sc3_UMAP_data_teams1_4_team4.jpeg", height = 4, width = 4)
...
ggsave("./publication/figures/figure4/sc3_UMAP_data_teams1.pdf", height = 5, width = 11)
ggsave("./publication/figures/figure4/sc3_UMAP_data_teams1.jpeg", height = 5, width = 11)
